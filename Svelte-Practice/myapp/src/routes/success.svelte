<script>
    ...
    import banner from '../assets/success.png'
    import Banneroverlay from "./banneroverlay.svelte";
    export let id = "success";
...
<IntersectionObserver {element} bind:intersecting threshold={1} >
    ...
    <div class="trigger " {id} bind:this={element}>
        ...
        <img src={banner} alt="A man cheering as the hand coming out of the laptop gives a thumbs up" >
        <p>Thank you so much! Now I can run my business!</p>
    </div>
